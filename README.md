...
* MongoDB: предоставляет гибкую схему хранения данных, но уступает реляционным базам данных при выполнении сложных аналитических запросов.
* ClickHouse: отлично подходит для высокоскоростной аналитики на больших объемах данных, но является избыточным решением для хранения около 100 000 записей.
